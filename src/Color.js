import { CLR_NODE, CLR_INPUT_NODE, CLR_OUTPUT_NODE, CLR_EXTERNAL_NODE, CLR_NODE_ACTIVATED } from './Constants';
...
export function get_node_color(node) {
    ...
    else if (node.__type === "external") { color = CLR_EXTERNAL_NODE; }
